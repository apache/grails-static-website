...
![Blog post image 2016-05-28-img01](2016-05-28-img01.png)
...
The app allows a user to create new todo lists and add new todo items to them. All changes are saved to the mongo database. It also makes use of [JSON Views](https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson) to customize the JSON output from our endpoints.
...
![Blog post image 2016-05-28-img02](2016-05-28-img02.png)
