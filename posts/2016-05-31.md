...
See the [documentation for the 1.1 milestone 2 version](https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson) of the JSON views plugin for more information.
