...
Upgrade instructions are available in the [documentation](https://grails.apache.org/docs/7.0.0-M4/guide/upgrading.html#upgrading60x). 
...
* See all in the [grails-bom](https://grails.apache.org/docs/7.0.0-M4/ref/Versions/Grails%20BOM.html).

## Installing Grails 7.0.0-M4
Try out Grails 7.0.0-M4 today by visiting the online app creator * [Grails Forge](https://grails.apache.org/start/).
...
3. Make any necessary adjustments to your application code, configuration, and dependencies to ensure compatibility with
   the new version. See https://grails.apache.org/docs/7.0.0-M4/guide/upgrading.html#upgrading60x.
...
Visit [Grails Forge](https://grails.apache.org/start/) and generate a new Grails application with Grails 7.0.0-M4. Compare the
