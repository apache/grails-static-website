...
Upgrade instructions are available in the [documentation](https://docs.grails.org/7.0.0-M4/guide/upgrading.html#upgrading60x). 
...
3. Make any necessary adjustments to your application code, configuration, and dependencies to ensure compatibility with
   the new version. See https://docs.grails.org/7.0.0-M4/guide/upgrading.html#upgrading60x.
