...
In a `.gsp`, this information is available by using the meta tag like this: (see the [tag](https://grails.apache.org/docs/latest/guide/theWebLayer.html#gsp) documentation).
