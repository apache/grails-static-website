...
* [Testcontainers](https://java.testcontainers.org/) features are also available on [Grails Forge](https://grails.apache.org/start/) and Grails Forge CLI for MySQL, PostgreSQL, SQL Server and MongoDB.
...
* [Grails Forge](https://grails.apache.org/start/) does not generate `buildSrc/` or `settings.gradle` by default, but they are optional features.  This simplifies build and Gradle plugin configuration and consolidates version management into one location.  
...
Try out Grails 7.0.0-M1 today by visiting the online app creator * [Grails Forge](https://grails.apache.org/start/).
...
Visit [Grails Forge](https://grails.apache.org/start/) and generate a new Grails application with Grails 7.0.0-M1. Compare the versions in the newly generated application with your existing one to identify any discrepancies. This can serve as a reference point for your update.
