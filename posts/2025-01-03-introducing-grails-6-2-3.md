...
You can get started with Grails 6.2.3 today by visiting our [official website](https://grails.apache.org/start/). Alternatively, you can quickly install Grails 6.2.3 using the [SDKMan](https://sdkman.io/).
...
Visit [https://grails.apache.org/start/](https://grails.apache.org/start/) and generate a new Grails application with Grails 6.2.3. Compare the versions in the newly generated application with your existing one to identify any discrepancies. This can serve as a reference point for your update.
