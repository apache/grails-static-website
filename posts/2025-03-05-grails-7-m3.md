...
Try out Grails 7.0.0-M3 today by visiting the online app creator * [Grails Forge](https://grails.apache.org/start/).
...
Visit [Grails Forge](https://grails.apache.org/start/) and generate a new Grails application with Grails 7.0.0-M3. Compare the
