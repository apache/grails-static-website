...
* `initial/` - the starting Grails 8 project, generated from link:https://grails.apache.org/start/[grails.apache.org/start] with the `postgres` and `testcontainers` features.
