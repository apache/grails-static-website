...
dependencies {
...
include::../snippets/build.gradle[tags=mysqlConnector]
...
}
----
...
----
include::../snippets/grails-app/conf/application.yml[tags=dataSource]
include::../snippets/grails-app/conf/application.yml[tags=dbUrl]
----
