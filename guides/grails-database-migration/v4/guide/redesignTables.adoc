...
include::../snippets/grails-app/domain/demo/Person.groovy[tag=hasMany]

include::../snippets/grails-app/domain/demo/Person.groovy[tag=openConstraints]
include::../snippets/grails-app/domain/demo/Person.groovy[tag=ageConstraints]       
include::../snippets/grails-app/domain/demo/Person.groovy[tag=closeConstraints]
...
----
include::../snippets/grails-app/domain/demo/Address.groovy[indent=0]
----
