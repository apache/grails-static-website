...
buildscript {
   dependencies {
      ...
include::../snippets/build.gradle[tags=databaseMigrationBuildscriptDependency]
   }
}

dependencies {
    ...
include::../snippets/build.gradle[tags=databaseMigrationDependency]
include::../snippets/build.gradle[tags=liquibaseDependency]    
}
----
...
.build.gradle
----
include::../snippets/build.gradle[tags=migrationsFolder]
----
