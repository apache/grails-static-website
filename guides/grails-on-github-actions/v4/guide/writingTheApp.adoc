...
with the https://grails.apache.org/start/[Grails Application Forge].
...
...
    dependencies {
    ...
include::../snippets/build.gradle[tag=buildscriptwebdriverbinaries]
    }
}
...
...
...
include::../snippets/build.gradle[tag=applywebdriverbinaries]
...
dependencies {
    ...
    ...
include::../snippets/build.gradle[tag=gebdependencies]
}
