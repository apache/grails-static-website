https://grails.apache.org/docs/latest/guide/testing.html#functionalTesting[Functional Tests] involve making HTTP
...
----
include::../snippets/src/integration-test/groovy/intranet/backend/AnnouncementControllerSpec.groovy[indent=0,lines="1..38, 99"]
----
