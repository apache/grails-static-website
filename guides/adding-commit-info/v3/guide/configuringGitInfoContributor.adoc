...
----
include::../snippets/grails-app/conf/application.yml[tag=cmpYmlP1]
----
...
----
include::../snippets/build.gradle[tag=gradleBuildscriptP5]
----

[source,groovy]
./complete/src/integration-test/groovy/demo/InfoSpec.groovy
----
include::../snippets/src/integration-test/groovy/demo/InfoSpec.groovy[]
----
