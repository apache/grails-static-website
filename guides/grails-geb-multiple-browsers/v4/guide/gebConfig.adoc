...
----
include::../snippets/src/integration-test/resources/GebConfig.groovy[indent=0]
----
...
./build.gradle
----
include::../snippets/build.gradle[indent=0,tag=gebDependencies]
----
...
./build.gradle
----
include::../snippets/build.gradle[indent=0,tag=systemProperties]
----
