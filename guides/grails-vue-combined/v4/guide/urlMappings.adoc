...
Edit `server/grails-app/controllers/example/grails/UrlMappings.groovy`:
...
----
include::../snippets/server/grails-app/controllers/example/grails/UrlMappings.groovy[indent=0, tag=defaultPage]
----
