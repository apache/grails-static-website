...
purposes of following along with this guide, you may choose to https://grails.apache.org/download.html[install]
...
https://grails.apache.org/start/ and create our application using the *Grails
Application Forge*.
...
This is called a
https://grails.apache.org/guides/grails-quickcasts-multi-project-builds/guide/index.html[multi-project
build].
