...
https://grails.apache.org/plugins.html[Spring
...
./server/build.gradle
----
include::../snippets/server/build.gradle[indent=0,tag=websocketDependency]
----
...
----
include::../snippets/server/src/main/groovy/demo/CustomWebSocketConfig.groovy[]
----
...
----
include::../snippets/server/src/main/groovy/demo/TokenCreationEventListener.groovy[]
----
...
----
include::../snippets/server/src/main/groovy/demo/SessionExpirationJobHolder.groovy[]
----
...
----
include::../snippets/server/grails-app/conf/spring/resources.groovy[]
----
...
----
include::../snippets/server/grails-app/init/demo/Application.groovy[]
----
...
----
include::../snippets/server/grails-app/conf/application.yml[indent=0,tag=allowedOrigin]
----
...
https://grails.apache.org/docs/latest/guide/conf.html[Grails documentation] for
