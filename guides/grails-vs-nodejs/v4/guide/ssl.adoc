...
<li><a href="https://grails.apache.org/docs/latest/guide/deployment.html#deploymentTasks">Configure JKS with Grails (docs)</a></li>
</ul>
++++
...
----
include::../snippets/server/grails-app/conf/application.yml[indent=0,tag=ssl]
----
