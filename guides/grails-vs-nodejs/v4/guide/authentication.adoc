...
https://grails.apache.org/plugins.html[Grails
...
./server/build.gradle
----
include::../snippets/server/build.gradle[indent=0,tag=securityDependency]
----
...
----
include::../snippets/server/grails-app/conf/application.yml[tag=springsecurity]
----
...
----
include::../snippets/server/grails-app/domain/demo/User.groovy[]
----
...
----
include::../snippets/server/grails-app/domain/demo/Role.groovy[]
----

[source, groovy]
./server/grails-app/domain/demo/UserRole.groovy
----
include::../snippets/server/grails-app/domain/demo/UserRole.groovy[]
----
...
----
include::../snippets/server/src/main/groovy/demo/UserPasswordEncoderListener.groovy[]
----
