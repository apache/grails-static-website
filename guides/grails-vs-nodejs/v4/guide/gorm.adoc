...
./server/build.gradle
----
include::../snippets/server/build.gradle[indent=0,tag=postgresDependency]
----
...
----
include::../snippets/server/grails-app/conf/application.yml[indent=0,tag=postgres]
----
...
we’ll specify our domain model in code, by writing https://grails.apache.org/docs/latest/ref/Domain%20Classes/Usage.html[*Domain Classes*].
...
https://grails.apache.org/docs/latest/ref/Database%20Mapping/Usage.html[Database Mapping]
____
