NOTE: This guide uses Multi-Tenancy DATABASE mode. To learn more, read https://grails.apache.org/guides/database-per-tenant/guide/index.html[Database per Tenant Multi-Tenancy] Guide.
