...
----
include::../snippets/src/main/groovy/demo/UserInsertedListener.groovy[]
----
...
----
...
include::../snippets/grails-app/conf/spring/resources.groovy[tag=userInsertedListenerImport]
...
beans = {
...
include::../snippets/grails-app/conf/spring/resources.groovy[tag=userInsertedListenerBean]
...
}
----
...
----
include::../snippets/src/main/groovy/demo/DatabaseConfiguration.groovy[]
----

[source,groovy]
.grails-app/services/demo/DatabaseProvisioningService.groovy
----
include::../snippets/grails-app/services/demo/DatabaseProvisioningService.groovy[]
----
