Before we can define our URL mappings, we need to create some *controllers*. You can think of them as the "web layer" of our application. Controllers respond to requests (i.e., from a user's browser, or from another microservice), obtain data from the model, and return a response, such as an HTML page or a JSON string.
...
Go ahead and quit the Grails CLI:
...
----
include::../snippets/grails-app/controllers/demo/TalkController.groovy[]
----

[source,groovy]
.grails-app/controllers/demo/SpeakerController.groovy
----
include::../snippets/grails-app/controllers/demo/SpeakerController.groovy[]
----

[source,groovy]
.grails-app/controllers/demo/AgendaController.groovy
----
include::../snippets/grails-app/controllers/demo/AgendaController.groovy[]
----
...
----
include::../snippets/grails-app/controllers/demo/ConferenceController.groovy[]
----
