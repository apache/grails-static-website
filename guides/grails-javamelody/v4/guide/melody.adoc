...
.build.gradle
----
include::../snippets/build.gradle[indent=0, tag=monitoringDependency]
----
...
.build.gradle
----
include::../snippets/build.gradle[indent=0, tag=monitoringDependencyTransitive]
----
...
----
include::../snippets/grails-app/conf/application.yml[indent=0, tag=monitoringConfig]
----
