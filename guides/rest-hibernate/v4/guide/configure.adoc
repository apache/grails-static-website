...
----
include::../snippets/grails-app/conf/application.yml[tags=dataSourceConfig,indent=0]
----
...
.grails-app/conf/application.yml
----
include::../snippets/grails-app/conf/application.yml[tags=envConfig,indent=0]
----
