...
----
include::../snippets/src/test/groovy/hibernate/example/ProductControllerSpec.groovy[tags=spec,indent=0]
    ...
}
----
...
.src/test/groovy/hibernate/example/ProductControllerSpec.groovy
----
include::../snippets/src/test/groovy/hibernate/example/ProductControllerSpec.groovy[tags=config,indent=0]
----
...
.src/test/groovy/hibernate/example/ProductControllerSpec.groovy
----
include::../snippets/src/test/groovy/hibernate/example/ProductControllerSpec.groovy[tags=setup,indent=0]
----
...
.src/test/groovy/hibernate/example/ProductControllerSpec.groovy
----
include::../snippets/src/test/groovy/hibernate/example/ProductControllerSpec.groovy[tags=test,indent=0]
----
