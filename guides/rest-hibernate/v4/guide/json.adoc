Grails uses https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson[JSON Views] to represent render JSON responses. The idea being to continue the philosophy of separating the controller logic from the view logic.
...
----
include::../snippets/grails-app/views/object/_object.gson[indent=0]
----
...
.grails-app/views/product/_product.gson
----
include::../snippets/grails-app/views/product/_product.gson[indent=0]
----
...
TIP: JSON Views are very flexible, for more information on customizing the output to your needs see https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson[the documentation].
