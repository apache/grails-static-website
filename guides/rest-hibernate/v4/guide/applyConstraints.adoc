...
----
include::../snippets/grails-app/domain/hibernate/example/Product.groovy[tags=constraints,indent=0]
----
...
----
include::../snippets/src/test/groovy/hibernate/example/ProductSpec.groovy[tags=imports,indent=0]
----
...
.src/test/groovy/hibernate/example/ProductSpec.groovy
----
include::../snippets/src/test/groovy/hibernate/example/ProductSpec.groovy[tags=hibernateSpec,indent=0]
----
...
.src/test/groovy/hibernate/example/ProductSpec.groovy
----
include::../snippets/src/test/groovy/hibernate/example/ProductSpec.groovy[tags=testName,indent=0]
    ...
}
----
...
.src/test/groovy/hibernate/example/ProductSpec.groovy
----
include::../snippets/src/test/groovy/hibernate/example/ProductSpec.groovy[tags=testInvalid,indent=0]
----
...
.src/test/groovy/hibernate/example/ProductSpec.groovy
----
include::../snippets/src/test/groovy/hibernate/example/ProductSpec.groovy[tags=testValid,indent=0]
----
