...
----
include::../snippets/grails-app/controllers/hibernate/example/ProductController.groovy[tags=searchAction,indent=0]
----
...
----
include::../snippets/grails-app/controllers/hibernate/example/UrlMappings.groovy[tags=productMapping,indent=0]
----
