With the data model defined now it time to write https://grails.apache.org/docs/latest/guide/theWebLayer.html#controllers[a controller].
...
----
include::../snippets/grails-app/controllers/hibernate/example/ProductController.groovy[tag=controller, indent=0]
}
----
