...
----
include::../snippets/grails-app/domain/demo/Product.groovy[tags=constraints,indent=0]
----
...
----
include::../snippets/src/test/groovy/demo/ProductSpec.groovy[tag=imports]

include::../snippets/src/test/groovy/demo/ProductSpec.groovy[tag=clazz]
----
...
<4> Use the https://grails.apache.org/docs/latest/guide/testing.html[grails.testing.gorm.DomainUnitTest] trait to unit test single domain class.
...
.build.gradle
----
include::../snippets/build.gradle[tag=fongo]
----
...
Checkout https://grails.apache.org/guides/grails-test-domain-class-constraints/guide/index.html[How to test domain class constraints?] guide to learn more about testing constraints.
