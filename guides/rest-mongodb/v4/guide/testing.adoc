...
----
include::../snippets/src/test/groovy/demo/ProductControllerSpec.groovy[tag=imports]

include::../snippets/src/test/groovy/demo/ProductControllerSpec.groovy[tag=clazz]
----
...
<3> Use the https://grails.apache.org/docs/latest/guide/testing.html[grails.testing.web.controllers.ControllerUnitTest] trait to unit test controllers.
