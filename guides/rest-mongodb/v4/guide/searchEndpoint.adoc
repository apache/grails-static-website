...
----
include::../snippets/grails-app/controllers/demo/ProductController.groovy[tags=searchAction,indent=0]
----
...
----
include::../snippets/grails-app/controllers/demo/UrlMappings.groovy[tags=productMapping,indent=0]
----
