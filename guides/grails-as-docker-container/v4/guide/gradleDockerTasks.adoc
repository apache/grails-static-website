...
.build.gradle
----
include::../snippets/build.gradle[indent=0, tag=import]
...
..
.
include::../snippets/build.gradle[indent=0, tag=extVariables]
include::../snippets/build.gradle[indent=0, tag=prepareDocker]
include::../snippets/build.gradle[indent=0, tag=createDockerfile]
include::../snippets/build.gradle[indent=0, tag=buildImage]
----
...
----
include::../snippets/src/main/docker/app-entrypoint.sh[]
----
