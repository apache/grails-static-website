...
----
include::../snippets/grails-app/conf/spring/resources.groovy[tag=cookieClearingImport]
beans {
...
..
.
include::../snippets/grails-app/conf/spring/resources.groovy[tag=cookieClearing]
}
----
...
----
include::../snippets/grails-app/conf/application.groovy[tag=logoutHandlers]
----