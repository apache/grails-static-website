...
----
include::../snippets/complete/src/test/groovy/example/grails/JobExamplesControllerSpec.groovy[]
----

[source,groovy]
.src/test/groovy/example/grails/JobExamplesServiceSpec.groovy
----
include::../snippets/complete/src/test/groovy/example/grails/JobExamplesServiceSpec.groovy[]
----
