...
----
include::../snippets/src/main/groovy/demo/ColorRequestHandlerFactory.groovy[indent=0]
----

[source,groovy]
./src/main/groovy/demo/ColorRequestHandler.groovy
----
include::../snippets/src/main/groovy/demo/ColorRequestHandler.groovy[indent=0]
----
...
include::../snippets/grails-app/controllers/demo/AssistantActionController.groovy[tag=color]
...
----
include::../snippets/src/main/groovy/demo/util/ColorUtils.java[indent=0]
----
