We create a _Controller_ for the _Domain class_ we previously created. Our Controller extends  https://grails.apache.org/docs/latest/guide/webServices.html#restfulControllers[RestfulController]. This
...
----
include::../snippets/grails-app/controllers/intranet/backend/v1/AnnouncementController.groovy[indent=0,lines="1..13"]
----
...
Grails enables powerful https://grails.apache.org/docs/latest/guide/theWebLayer.html#urlmappingss[URL mapping] configuration to
do that. Add the next line to the mappings closure:

[source,groovy]
./grails-app/controllers/intranet/backend/UrlMappings.groovy
----
include::../snippets/grails-app/controllers/intranet/backend/UrlMappings.groovy[lines="13"]
