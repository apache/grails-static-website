...
Check the guide https://grails.apache.org/guides/command-objects-and-forms/guide/index.html[Using Command Objects to handle form data] to learn more about command objects.

[source, groovy]
.grails-app/controllers/demo/StudentSaveCommand.groovy
----
include::../snippets/grails-app/controllers/demo/StudentSaveCommand.groovy[]
----
...
include::../snippets/grails-app/controllers/demo/StudentController.groovy[tag=saveAction]
...
include::../snippets/src/test/groovy/demo/StudentControllerSpec.groovy[tag=testSave1]
...
include::../snippets/src/test/groovy/demo/StudentControllerSpec.groovy[tag=testSave2]
...
include::../snippets/src/test/groovy/demo/StudentControllerSpec.groovy[tag=testSave3]
