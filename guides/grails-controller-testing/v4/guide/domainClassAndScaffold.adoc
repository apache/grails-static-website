...
----
include::../snippets/grails-app/domain/demo/Student.groovy[indent=0]
----
...
Learn more about testing domain classes in the https://grails.apache.org/guides/grails-test-domain-class-constraints/guide/index.html[How to test Domain Class constraints?] Guide.
