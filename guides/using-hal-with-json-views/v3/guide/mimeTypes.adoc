...
----
include::../snippets/grails-app/conf/application.yml[indent=0,lines="36..52"]
----
...
.grails-app/conf/application.yml
----
include::../snippets/grails-app/conf/application.yml[indent=0,lines="50..63"]
----
...
----
include::../snippets/grails-app/views/product/show_mime.gson[]
----
...
include::../snippets/src/test/groovy/com/example/ProductShowSpec.groovy[indent=0,lines=20..44]
----
