...
----
include::../snippets/grails-app/views/product/show.gson[]
----
...
[source, groovy]
----
include::../snippets/src/integration-test/groovy/com/example/ProductsShowFuncSpec.groovy[indent=0,lines=23..47]
----
...
----
include::../snippets/grails-app/views/order/show_v4.gson[indent=0,lines="1..9"]
----
...
[source, groovy]
----
include::../snippets/src/integration-test/groovy/com/example/OrdersShowFuncSpec.groovy[lines=33..46]
----
