...
----
include::../snippets/grails-app/views/order/_product.gson[]
----
...
----
include::../snippets/grails-app/views/order/show_v3.gson[]
----
...
TIP: For more information on using templates in JSON views, see the https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson[Grails Views documentation].
...
[source, groovy]
----
include::../snippets/src/integration-test/groovy/com/example/OrderShowV3IntegrationSpec.groovy[indent=0,lines=23..78]
----
...
----
include::../snippets/grails-app/views/customer/_order.gson[]
----
...
----
include::../snippets/grails-app/views/customer/show.gson[]
----
