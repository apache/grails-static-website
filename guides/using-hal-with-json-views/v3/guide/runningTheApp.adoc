...
[source, groovy]
----
include::../snippets/../initial/src/integration-test/groovy/com/example/ProductsListSpec.groovy[indent=0,lines=22..44]
//...
]
----
...
[source, groovy]
----
include::../snippets/../initial/src/integration-test/groovy/com/example/OrderShowSpec.groovy[indent=0,lines=22..44]
----
