...
JSON views implement a Groovy trait https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson[`HalView`], which exposes a `hal` helper with several methods for outputting HAL-compliant JSON. One of those is the `links` method:
...
----
include::../snippets/grails-app/views/order/show_v2.gson[]
----
...
[source, groovy]
----
include::../snippets/src/integration-test/groovy/com/example/OrderShowV2IntegrationSpec.groovy[indent=0,lines=31..68]
    //...
}
----
