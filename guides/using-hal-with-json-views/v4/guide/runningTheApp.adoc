...
----
include::../snippets/../initial/grails-app/domain/com/example/Customer.groovy[indent=0,lines="1..7"]
----
...
Adding these annotations to our domain classes gives us a running start to creating our API. See the https://grails.apache.org/docs/latest/guide/webServices.html#domainResources[Grails documentation] for more information on `@Resource`
...
[source, groovy]
----
include::../snippets/../initial/src/integration-test/groovy/com/example/ProductsListSpec.groovy[indent=0,tag=productsJSON]
//...
]
----
...
[source, groovy]
----
include::../snippets/../initial/src/integration-test/groovy/com/example/OrderShowSpec.groovy[indent=0,tag=orderJSON]
----
