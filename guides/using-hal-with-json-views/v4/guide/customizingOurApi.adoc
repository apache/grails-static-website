...
----
include::../snippets/grails-app/views/order/show_v1.gson[]
----
...
[source, groovy]
----
include::../snippets/src/test/groovy/com/example/OrderShowV1Spec.groovy[indent=0,lines=25..50]
----
...
----
include::../snippets/grails-app/views/customer/show_v1.gson[]
----
