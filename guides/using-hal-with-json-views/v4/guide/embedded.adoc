...
[source, groovy]
----
include::../snippets/src/integration-test/groovy/com/example/ProductsShowFuncSpec.groovy[indent=0,lines=30..54]
----
...
----
include::../snippets/grails-app/views/order/show_v4.gson[indent=0]
----
...
[source, groovy]
----
include::../snippets/src/integration-test/groovy/com/example/OrdersShowFuncSpec.groovy[lines=33..99]
----
