...
----
include::../snippets/client/src/components/form/FieldSelect.vue[]
----
...
----
include::../snippets/client/src/components/table/TableRow.vue[]
----
...
----
include::../snippets/client/src/components/table/VehicleTable.vue[]
----
