...
./client/src/components/Garage.vue
----
include::../snippets/client/src/components/Garage.vue[tag=template]
----
...
./client/src/components/Garage.vue
----
include::../snippets/client/src/components/Garage.vue[tag=component]
----
...
./client/src/components/Garage.vue
----
include::../snippets/client/src/components/Garage.vue[tag=fetch]
----
...
./client/src/components/Garage.vue
----
include::../snippets/client/src/components/Garage.vue[tag=methods]
----
...
./client/src/components/Garage.vue
----
include::../snippets/client/src/components/Garage.vue[tag=submit]
----
...
./client/src/components/Garage.vue
----
include::../snippets/client/src/components/Garage.vue[tag=css]
----
