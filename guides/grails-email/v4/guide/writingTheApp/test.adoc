...
.build.gradle
----
include::../../snippets/build.gradle[tag=dependencySpockSpring]
----
...
----
include::../../snippets/grails-app/init/example/grails/Application.groovy[]
----
...
----
include::../../snippets/src/integration-test/groovy/example/grails/MailControllerSpec.groovy[]
----
