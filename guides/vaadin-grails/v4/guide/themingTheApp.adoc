...
----
include::../snippets/src/main/groovy/demo/DemoGrailsUI.groovy[indent=0,lines="23..23"]
----
...
----
include::../snippets/src/main/webapp/VAADIN/themes/vaadin-grails-theme/styles.scss[]
----
...
----
include::../snippets/src/main/webapp/VAADIN/themes/vaadin-grails-theme/vaadin-grails-theme.scss[indent=0,lines="32..38"]
----
