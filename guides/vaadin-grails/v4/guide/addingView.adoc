...
----
include::../snippets/src/main/groovy/demo/GarageView.groovy[]
----
...
.src/main/groovy/demo/GarageView.groovy
----
include::../snippets/src/main/groovy/demo/GarageView.groovy[indent=0, tag=listeners]
----
...
.src/main/groovy/demo/GarageView.groovy
----
include::../snippets/src/main/groovy/demo/GarageView.groovy[indent=0, tag=navigateTo]
----
