...
https://grails.apache.org/guides/grails-geb-multiple-browsers/guide/index.html[Geb tests for multiple browsers].

[source, groovy]
.gradle/geb.gradle
----
include::../snippets/gradle/geb.gradle[indent=0]
----
