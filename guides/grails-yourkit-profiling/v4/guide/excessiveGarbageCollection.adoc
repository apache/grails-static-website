...
----
include::../snippets/../initial/grails-app/services/demo/StudentService.groovy[tag=htmlUnorderedListOfStudents]
----
...
.grails-app/services/demo/StudentService.groovy
----
include::../snippets/grails-app/services/demo/StudentService.groovy[tag=htmlUnorderedListOfStudents]
----
