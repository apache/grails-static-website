...
----
include::../snippets/../initial/grails-app/services/demo/StudentService.groovy[tag=deleteStudents]
----
...
.grails-app/services/demo/StudentService.groovy
----
include::../snippets/grails-app/services/demo/StudentService.groovy[tag=deleteStudents]
----
...
interface StudentDataService {
  ...
include::../snippets/grails-app/services/demo/StudentDataService.groovy[tag=deleteByGradleLessThan]
...
}
----
