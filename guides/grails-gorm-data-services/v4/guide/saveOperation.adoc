...
----
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=savePerson, indent=false]
----
...
----
include::../snippets/src/test/groovy/example/grails/PersonDataServiceSpec.groovy[tag=test2, indent=false]
----
