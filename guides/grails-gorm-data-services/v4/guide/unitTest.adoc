...
----
include::../snippets/src/test/groovy/example/grails/PersonDataServiceWithoutHibernateSpec.groovy[tag=packagedeclaration]

include::../snippets/src/test/groovy/example/grails/PersonDataServiceWithoutHibernateSpec.groovy[tag=imports]

class PersonDataServiceSpec extends Specification { // <1>

include::../snippets/src/test/groovy/example/grails/PersonDataServiceWithoutHibernateSpec.groovy[tag=classContent]
}
----
...
Luckily, https://grails.apache.org/plugins.html[Grails Hibernate Plugin] includes a utility class `grails.test.hibernate.HibernateSpec` which you could extend from and simplify
the previous unit test:

[source, groovy]
.src/test/groovy/example/grails/PersonDataServiceSpec.groovy
----
include::../snippets/src/test/groovy/example/grails/PersonDataServiceSpec.groovy[tag=PersonDataServiceSpec]
}
----