...
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=findByName]

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=count]

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=delete]
