...
----
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=findEagerly, indent=false]
----
...
.grails-app/services/example/grails/PersonDataService.groovy
----
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=packageDeclaration]

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=serviceImport]
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=joinImport]
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=miscImports]

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=IPersonDataService]

    Person findByName(String name)

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=findPersonAge]

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=countPerson]

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=findEagerly]

    void delete(Serializable id)

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=savePerson]

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=save]

}

include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=abstractClass]
----
...
----
include::../snippets/src/integration-test/groovy/example/grails/PersonDataServiceIntSpec.groovy[tag=clazz]

include::../snippets/src/integration-test/groovy/example/grails/PersonDataServiceIntSpec.groovy[tag=findEagerly]
...
----
include::../snippets/grails-app/conf/logback.groovy[tag=hqlLogger]
----
