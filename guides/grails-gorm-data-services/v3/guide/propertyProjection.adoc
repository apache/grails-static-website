...
----
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=findPersonAge, indent=false]
----
...
----
include::../snippets/src/test/groovy/example/grails/PersonDataServiceSpec.groovy[tag=test1, indent=false]
----