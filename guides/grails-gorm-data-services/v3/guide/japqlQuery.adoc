...
----
include::../snippets/grails-app/services/example/grails/PersonDataService.groovy[tag=findAllByCountry, indent=false]
----
...
include::../snippets/src/integration-test/groovy/example/grails/PersonDataServiceIntSpec.groovy[tag=findAllByCountry]
----