...
----
include::../snippets/src/test/groovy/demo/VehicleControllerSpec.groovy[tags=class, indent=0]
	...
}
----
...
.src/test/groovy/demo/VehicleControllerSpec.groovy
----
include::../snippets/src/test/groovy/demo/VehicleControllerSpec.groovy[tags=config, indent=0]
----

This will allow you to use link:https://grails.apache.org/docs/latest/api/org/grails/datastore/mapping/multitenancy/resolvers/SystemPropertyTenantResolver.html[SystemPropertyTenantResolver] for changing the tenant id within the test.
...
.src/test/groovy/demo/VehicleControllerSpec.groovy
----
include::../snippets/src/test/groovy/demo/VehicleControllerSpec.groovy[tags=setup, indent=0]
----
...
.src/test/groovy/demo/VehicleControllerSpec.groovy
----
include::../snippets/src/test/groovy/demo/VehicleControllerSpec.groovy[tags=cleanup, indent=0]
----
...
.src/test/groovy/demo/VehicleControllerSpec.groovy
----
include::../snippets/src/test/groovy/demo/VehicleControllerSpec.groovy[tags=index, indent=0]
----
...
.src/test/groovy/demo/VehicleControllerSpec.groovy
----
include::../snippets/src/test/groovy/demo/VehicleControllerSpec.groovy[tags=noTenant, indent=0]
----
...
.src/test/groovy/demo/VehicleControllerSpec.groovy
----
include::../snippets/src/test/groovy/demo/VehicleControllerSpec.groovy[tags=save, indent=0]
----
