...
----
include::../snippets/grails-app/views/book/show.gsp[indent=0]
----
...
----
include::../snippets/grails-app/views/layouts/main.gsp[indent=0, tag=menu]
----
...
----
include::../snippets/grails-app/views/auth/_loginWithTwitter.gsp[]
----
