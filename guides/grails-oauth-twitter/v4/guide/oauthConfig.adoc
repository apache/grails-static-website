...
----
include::../snippets/grails-app/conf/application.groovy[indent=0,tag=staticRules]
----
...
.grails-app/conf/application.groovy
----
include::../snippets/grails-app/conf/application.groovy[indent=0,tag=grailsPluginSpringSecurityRest]
----
...
.grails-app/conf/application.groovy
----
include::../snippets/grails-app/conf/application.groovy[indent=0,tag=filterChain]
----
