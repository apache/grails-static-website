...
----
include::../snippets/grails-app/controllers/com/ociweb/quickcasts/QuickcastController.groovy[]
----
...
./build.gradle
----
include::../snippets/build.gradle[indent=0,tag=micronaut-http-client]
----
...
./build.gradle
----
include::../snippets/build.gradle[indent=0,tag=xmlunit]
----
