...
----
include::../snippets/grails-app/controllers/com/ociweb/quickcasts/QuickcastController.groovy[indent=0,lines="1..6,12..16"]
----
...
----
include::../snippets/grails-app/conf/application.yml[indent=0,lines="1..5"]
----
...
----
include::../snippets/grails-app/services/com/ociweb/quickcasts/RelatedQuickcastsService.groovy[indent=0]
----

The `QuickcastController` index method renders a `Quickcast` using the next https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson[Markup View]

[source,groovy]
./grails-app/views/quickcast/show.gml
----
include::../snippets/grails-app/views/quickcast/show.gml[indent=0]
----
...
----
include::../snippets/src/integration-test/groovy/com/ociweb/quickcasts/QuickcastControllerShowSpec.groovy[indent=0]
----
