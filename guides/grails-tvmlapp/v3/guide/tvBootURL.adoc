...
----
include::../snippets/grails-app/assets/javascripts/application.js[indent=0]
----
...
./grails-app/assets/javascripts/application.js
----
include::../snippets/grails-app/assets/javascripts/application.js[indent=0, lines=8]
----
...
./grails-app/assets/javascripts/application.js
----
include::../snippets/grails-app/assets/javascripts/application.js[indent=0, lines=15]
----
