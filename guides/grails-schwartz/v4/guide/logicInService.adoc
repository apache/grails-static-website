...
----
include::../snippets/grails-app/services/demo/EmailService.groovy[]
----
...
----
include::../snippets/grails-app/services/demo/DailyEmailJobService.groovy[tag=dailyEmailJobService]
----
...
----
include::../snippets/grails-app/services/demo/todayat/DailyEmailJobService.groovy[tag=dailyEmailJobService]
----