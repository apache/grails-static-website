...
----
include::../snippets/src/integration-test/groovy/example/grails/PersonControllerIntSpec.groovy[tag=PersonControllerIntSpecBegin]

include::../snippets/src/integration-test/groovy/example/grails/PersonControllerIntSpec.groovy[tag=PersonControllerIntSpecCreateSuccess]

include::../snippets/src/integration-test/groovy/example/grails/PersonControllerIntSpec.groovy[tag=PersonControllerIntSpecEnd]
----
