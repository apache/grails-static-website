...
----
include::../snippets/grails-app/controllers/example/grails/PersonController.groovy[tag=personControllerCreate]
include::../snippets/grails-app/controllers/example/grails/PersonController.groovy[tag=personControllerEnd]
----