...
----
include::../snippets/grails-app/controllers/example/grails/PersonController.groovy[tag=personControllerOfferAdvice]
----
...
----
include::../snippets/src/main/groovy/example/grails/AgeAdvisor.groovy[]
----
