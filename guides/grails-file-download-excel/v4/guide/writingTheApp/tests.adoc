...
.build.gradle
----
include::../../snippets/build.gradle[tag=geb]
----
...
----
include::../../snippets/src/integration-test/resources/GebConfig.groovy[]
----
...
----
include::../../snippets/src/integration-test/groovy/example/grails/HomePage.groovy[]
----
...
..
    ...
    dependencies {
include::../../snippets/build.gradle[tag=buildscriptDependenciesWebdriverBinaries]
    }
}

include::../../snippets/build.gradle[tag=applyPluginWebdriverBinaries]
...
include::../../snippets/build.gradle[tag=webdriverBinaries]

include::../../snippets/build.gradle[tag=taskWithTypeTest]
----
...
----
include::../../snippets/src/integration-test/groovy/example/grails/DownloadExcelSpec.groovy[]
----
