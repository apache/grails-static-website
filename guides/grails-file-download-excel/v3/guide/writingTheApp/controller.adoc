...
----
include::../../snippets/grails-app/controllers/example/grails/ExcelController.groovy[]
----

<1> Implement `grails.core.support.GrailsConfigurationAware` to
configure mime types and encoding configuration.
<2> A controller method can access the https://grails.apache.org/docs/3.3.8/ref/Servlet%20API/response.html[response] object which is an instace of Servlet API’s https://docs.oracle.com/javaee/7/api/javax/servlet/http/HttpServletResponse.html[HttpServletResponse] class
