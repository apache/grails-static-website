...
----
include::../snippets/src/main/groovy/demo/controller/VehicleController.groovy[]
----
...
----
include::../snippets/src/test/groovy/demo/controller/VehicleControllerTest.groovy[]
----

[source,groovy]
./src/main/groovy/demo/controller/ManufacturerController.groovy
----
include::../snippets/src/main/groovy/demo/controller/ManufacturerController.groovy[]
----
...
----
include::../snippets/src/test/groovy/demo/controller/ManufacturerControllerTest.groovy[]
----
