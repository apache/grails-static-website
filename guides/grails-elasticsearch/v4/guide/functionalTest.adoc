...
----
include::../snippets/src/integration-test/groovy/demo/RestSpec.groovy[]
----

[source, groovy]
.src/integration-test/groovy/demo/BookControllerFunctionalSpec.groovy
----
include::../snippets/src/integration-test/groovy/demo/BookControllerFunctionalSpec.groovy[]
----
