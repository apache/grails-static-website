...
.build.gradle
----
include::../snippets/build.gradle[tag=elasticSearchVersion]
----
...
----
include::../snippets/build.gradle[tag=elasticSearchPlugin]
----
...
----
include::../snippets/grails-app/conf/application.yml[tag=elasticSearchConfig]
----
