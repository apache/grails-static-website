...
----
include::../snippets/grails-app/domain/grails/mock/basics/Student.groovy[indent=0]
----
...
----
include::../snippets/grails-app/domain/grails/mock/basics/Classroom.groovy[indent=0]
----
