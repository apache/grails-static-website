...
----
include::../snippets/grails-app/services/grails/mock/basics/ClassroomGradesNotificationService.groovy[indent=0]
----

[source, groovy]
.grails-app/services/grails/mock/basics/EmailService.groovy
----
include::../snippets/grails-app/services/grails/mock/basics/EmailService.groovy[indent=0]
----
