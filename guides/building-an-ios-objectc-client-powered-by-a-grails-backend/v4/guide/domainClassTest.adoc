https://grails.apache.org/docs/latest/guide/testing.html[Grails makes testing easier] from low level unit testing to high
...
----
include::../snippets/src/test/groovy/intranet/backend/AnnouncementSpec.groovy[indent=0,lines="1..5, 9..50"]
----
