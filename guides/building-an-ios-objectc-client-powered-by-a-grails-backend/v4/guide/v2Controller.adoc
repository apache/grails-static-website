...
----
include::../snippets/grails-app/controllers/intranet/backend/v2/AnnouncementController.groovy[]
----
...
----
include::../snippets/grails-app/services/intranet/backend/AnnouncementService.groovy[]
----
...
----
include::../snippets/src/test/groovy/intranet/backend/AnnouncementServiceSpec.groovy[]
...
----
include::../snippets/grails-app/controllers/intranet/backend/UrlMappings.groovy[lines="15,16"]
