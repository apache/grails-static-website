...
----
include::../snippets/grails-app/conf/application.yml[tag=countries]
----
...
----
include::../snippets/src/main/groovy/demo/Country.groovy[]
----
...
----
include::../snippets/grails-app/services/demo/CountryService.groovy[]
----