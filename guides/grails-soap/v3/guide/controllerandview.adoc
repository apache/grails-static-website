...
----
include::../snippets/grails-app/controllers/demo/VatCommand.groovy[]
----
...
----
include::../snippets/grails-app/controllers/demo/VatController.groovy[]
----
...
----
include::../snippets/grails-app/views/vat/index.gsp[]
----