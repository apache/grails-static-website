...
----
include::../snippets/../complete-currentuser/src/main/groovy/demo/CurrentUserTenantResolver.groovy[]
----
...
----
include::../snippets/../complete-currentuser/grails-app/conf/spring/resources.groovy[tag=currentUserTenantResolverImport]
include::../snippets/../complete-currentuser/grails-app/conf/spring/resources.groovy[tag=beans]
include::../snippets/../complete-currentuser/grails-app/conf/spring/resources.groovy[tag=currentUserTenantResolver]
}
----
...
----
include::../snippets/../complete-currentuser/src/integration-test/groovy/demo/CurrentUserTenantResolverSpec.groovy[]
----
...
----
grails
include::../snippets/../complete-currentuser/grails-app/conf/application.yml[tag=multiTenancyConfiguration]
----
