...
----
include::../snippets/src/main/groovy/demo/CurrentUserByJwtTenantResolver.groovy[]
----
...
----
include::../snippets/grails-app/conf/spring/resources.groovy[tag=tenantResolverImport]
include::../snippets/grails-app/conf/spring/resources.groovy[tag=beans]
include::../snippets/grails-app/conf/spring/resources.groovy[tag=tenantResolverBean]
}
----
...
----
include::../snippets/src/integration-test/groovy/demo/CurrentUserByJwtTenantResolverSpec.groovy[]
----
...
----
grails
include::../snippets/grails-app/conf/application.yml[tag=multiTenancyConfiguration]
----
