...
./gradle.properties
----
include::../snippets/gradle.properties[]
----

[source,groovy]
./build.gradle
----
include::../snippets/build.gradle[tags=micronaut]
----
...
----
include::../snippets/src/integration-test/groovy/example/grails/BearerToken.groovy[indent=0]
----

[source,groovy]
./src/integration-test/groovy/example/grails/CustomError.groovy
----
include::../snippets/src/integration-test/groovy/example/grails/CustomError.groovy[indent=0]
----

[source,groovy]
./src/integration-test/groovy/example/grails/UserCredentials.groovy
----
include::../snippets/src/integration-test/groovy/example/grails/UserCredentials.groovy[indent=0]
----
...
----
include::../snippets/src/integration-test/groovy/example/grails/ApiAnnouncementControllerSpec.groovy[indent=0]
----
