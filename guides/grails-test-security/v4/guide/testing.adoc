...
----
include::../snippets/src/integration-test/groovy/example/grails/LoginPage.groovy[indent=0]
----

[source,groovy]
./src/integration-test/groovy/example/grails/AnnouncementListingPage.groovy
----
include::../snippets/src/integration-test/groovy/example/grails/AnnouncementListingPage.groovy[indent=0]
----

[source,groovy]
./src/integration-test/groovy/example/grails/AnnouncementControllerSpec.groovy
----
include::../snippets/src/integration-test/groovy/example/grails/AnnouncementControllerSpec.groovy[indent=0]
----
