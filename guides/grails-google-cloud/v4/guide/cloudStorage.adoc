...
.build.gradle
----
include::../snippets/build.gradle[tag=cloudstorage]
----
...
.build.gradle
----
include::../snippets/build.gradle[tag=configurationsexclude]
----
...
----
include::../snippets/grails-app/conf/application.yml[tag=bucket]
----
...
----
include::../snippets/grails-app/controllers/demo/FeaturedImageCommand.groovy[]
----
...
----
include::../snippets/grails-app/controllers/demo/BookController.groovy[tag=featuredImage]
----
...
----
include::../snippets/grails-app/services/demo/UploadBookFeaturedImageService.groovy[]
----
...
----
include::../snippets/grails-app/services/demo/GoogleCloudStorageService.groovy[]
----
...
----
include::../snippets/grails-app/services/demo/BookGormService.groovy[tag=updateFeaturedImageUrl]
----
...
----
include::../snippets/grails-app/views/book/editFeaturedImage.gsp[]
----
