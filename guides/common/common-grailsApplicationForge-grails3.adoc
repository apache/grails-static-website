...
You can even download your project from the command line using a HTTP tool like `curl` (see https://grails.apache.org/start/[grails.apache.org/start] for API documentation):
