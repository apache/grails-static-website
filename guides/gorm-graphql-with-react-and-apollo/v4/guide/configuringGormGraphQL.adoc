...
.build.gradle
----
include::../snippets/server/build.gradle[indent=0,tag=graphqldependency]
----
...
----
include::../snippets/server/grails-app/domain/com/objectcomputing/Talk.groovy[indent=0]
----
...
----
include::../snippets/server/grails-app/domain/com/objectcomputing/Speaker.groovy[indent=0]
----
