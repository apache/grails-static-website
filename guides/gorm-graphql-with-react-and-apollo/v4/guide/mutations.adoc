...
----
include::../snippets/client/src/Speaker.js[indent=0, tag=mutations]
----
...
.client/src/Speaker.js
----
include::../snippets/client/src/Speaker.js[indent=0, tag=compose]
----
...
.client/src/Speaker.js
----
include::../snippets/client/src/Speaker.js[indent=0, tag=calling]
----
