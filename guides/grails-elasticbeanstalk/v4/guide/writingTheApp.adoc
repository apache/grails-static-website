...
----
include::../snippets/grails-app/conf/application.yml[tag=springbootactuator]
----
...
repositories {
    ..
include::../snippets/build.gradle[tag=mavenCentral]
    ..
}
dependencies {
    ..
include::../snippets/build.gradle[tag=micronaut-http-client]
    ..
}
----
...
----
include::../snippets/src/integration-test/groovy/example/grails/HealthSpec.groovy[]
----
