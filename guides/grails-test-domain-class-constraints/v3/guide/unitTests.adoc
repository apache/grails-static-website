...
We want to https://grails.apache.org/docs/latest/guide/testing.html[unit test] our validation constraints.
...
----
include::../snippets/src/test/groovy/demo/HotelSpec.groovy[indent=0,tags=testForTests]
----
...
./src/test/groovy/demo/HotelSpec.groovy
----
include::../snippets/src/test/groovy/demo/HotelSpec.groovy[indent=0,tags=nameTests]
----
...
./src/test/groovy/demo/HotelSpec.groovy
----
include::../snippets/src/test/groovy/demo/HotelSpec.groovy[indent=0,tags=urlTests]
----
...
./src/test/groovy/demo/HotelSpec.groovy
----
include::../snippets/src/test/groovy/demo/HotelSpec.groovy[indent=0,tags=emailTests]
----
...
----
include::../snippets/src/test/groovy/demo/HotelEmailUniqueConstraintSpec.groovy[]
----
...
----
include::../snippets/grails-app/domain/demo/Hotel.groovy[indent=0,tags=hotelMapping]
----
...
./src/test/groovy/demo/HotelSpec.groovy
----
include::../snippets/src/test/groovy/demo/HotelSpec.groovy[indent=0,tags=aboutTests]
----
...
However, a value such as `latitude` of 90.1 will be a valid value using the  https://grails.apache.org/docs/latest/ref/Constraints/range.html[Range Constraint]
____
...
Instead we are using a https://grails.apache.org/docs/latest/ref/Constraints/validator.html[custom validation].

[source,javascript]
./grails-app/domain/demo/Hotel.groovy
----
include::../snippets/grails-app/domain/demo/Hotel.groovy[indent=0,tags=latitudeCustomValidator]
----
...
./src/test/groovy/demo/HotelSpec.groovy
----
include::../snippets/src/test/groovy/demo/HotelSpec.groovy[indent=0,tags=latitudeAndLongitudeTests]
----
