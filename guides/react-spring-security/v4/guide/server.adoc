NOTE: The `initial` project is based on the completed project from the https://grails.apache.org/guides/building-a-react-app/guide/index.html[Building a React App] Guide. Please refer to that guide for details on the provided code.
