...
----
include::../snippets/grails-app/services/neo4j/movies/MovieService.groovy[tags=service]
   ...
}
----
...
.grails-app/services/neo4j/movies/MovieService.groovy
----
include::../snippets/grails-app/services/neo4j/movies/MovieService.groovy[tags=find, indent=0]
----
...
----
include::../snippets/grails-app/controllers/neo4j/movies/MovieController.groovy[tags=service, indent=0]
----
...
.grails-app/controllers/neo4j/movies/MovieController.groovy
----
include::../snippets/grails-app/controllers/neo4j/movies/MovieController.groovy[tags=show, indent=0]
----
...
To customize the JSON create a `grails-app/views/movie/_movie.gson` https://grails.apache.org/docs/latest/guide/theWebLayer.html#gson[JSON View] and populate it with the following contents:
...
----
include::../snippets/grails-app/views/movie/_cast.gson[]
----
