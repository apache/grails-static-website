...
----
include::../snippets/grails-app/services/neo4j/movies/MovieService.groovy[tags=graph, indent=0]
----
...
.grails-app/services/neo4j/movies/MovieService.groovy
----
include::../snippets/grails-app/services/neo4j/movies/MovieService.groovy[tags=d3format, indent=0]
----
...
----
include::../snippets/grails-app/controllers/neo4j/movies/MovieController.groovy[tags=graph, indent=0]
----
