...
----
include::../snippets/grails-app/controllers/neo4j/movies/MovieController.groovy[tags=controller]
   ...
}
----
...
----
include::../snippets/grails-app/controllers/neo4j/movies/UrlMappings.groovy[tags=endpoints]
----
