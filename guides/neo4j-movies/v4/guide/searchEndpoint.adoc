...
----
include::../snippets/grails-app/services/neo4j/movies/MovieService.groovy[tags=search, indent=0]
----
...
----
include::../snippets/grails-app/controllers/neo4j/movies/MovieController.groovy[tags=search, indent=0]
----
...
----
include::../snippets/grails-app/views/movie/search.gson[]
----
