...
----
include::../snippets/grails-app/domain/neo4j/movies/Person.groovy[]
----
...
----
include::../snippets/grails-app/domain/neo4j/movies/Movie.groovy[]
----
...
----
include::../snippets/grails-app/domain/neo4j/movies/CastMember.groovy[]
----
