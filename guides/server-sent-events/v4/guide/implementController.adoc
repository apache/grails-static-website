...
----
include::../snippets/grails-app/controllers/example/TickTockController.groovy[tags=rxjavaImports,indent=0]
----
...
.grails-app/controllers/example/TickTockController.groovy
----
include::../snippets/grails-app/controllers/example/TickTockController.groovy[indent=0,lines="18..19,39..40"]
----
...
.grails-app/controllers/example/TickTockController.groovy
----
include::../snippets/grails-app/controllers/example/TickTockController.groovy[tags=rxOnNext,indent=0]
----
...
.grails-app/controllers/example/TickTockController.groovy
----
include::../snippets/grails-app/controllers/example/TickTockController.groovy[tags=rxOnCompleted,indent=0]
----
...
.grails-app/controllers/example/TickTockController.groovy
----
include::../snippets/grails-app/controllers/example/TickTockController.groovy[tags=rxStream,indent=0]
----
...
.grails-app/controllers/example/TickTockController.groovy
----
include::../snippets/grails-app/controllers/example/TickTockController.groovy[tags=interval,indent=0]
----
