...
----
include::../snippets/grails-app/views/hotel/index.gsp[indent=0,lines="21"]
----
...
----
include::../snippets/grails-app/views/hotel/create.gsp[indent=0,lines="30"]
----

[source, groovy]
./grails-app/views/hotel/edit.gsp
----
include::../snippets/grails-app/views/hotel/edit.gsp[indent=0,lines="32"]
----
...
----
include::../snippets/grails-app/views/hotel/show.gsp[indent=0,lines="28"]
----
...
----
include::../snippets/grails-app/controllers/example/grails/HotelController.groovy[indent=0, tag=editFeaturedImage]
----
...
----
include::../snippets/grails-app/views/hotel/editFeaturedImage.gsp[indent=0,lines="29..36"]
----
