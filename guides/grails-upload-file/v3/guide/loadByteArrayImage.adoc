...
----
include::../snippets/grails-app/controllers/example/grails/RestaurantController.groovy[tag=featuredImage, indent=0]
----
...
----
include::../snippets/grails-app/views/restaurant/show.gsp[lines=22..25, indent=0]
----
