...
It has several Controllers, GORM Data Services, Domain classes and a simple CRUD interface built with https://grails.apache.org/docs/latest/guide/theWebLayer.html#gsp[GSP]s.
