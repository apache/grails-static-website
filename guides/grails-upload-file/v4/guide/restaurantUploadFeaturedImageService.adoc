...
include::../snippets/grails-app/controllers/example/grails/RestaurantController.groovy[tag=uploadFeaturedImage]
...
----
include::../snippets/grails-app/services/example/grails/RestaurantDataService.groovy[]
----
