...
----
include::../snippets/grails-app/controllers/example/grails/HotelController.groovy[tag=uploadFeaturedImage, indent=0]
----
...
----
include::../snippets/grails-app/services/example/grails/UploadHotelFeaturedImageService.groovy[]
----
...
----
include::../snippets/grails-app/services/example/grails/HotelDataService.groovy[]
----
