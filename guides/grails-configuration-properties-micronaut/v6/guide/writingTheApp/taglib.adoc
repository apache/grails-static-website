Create a https://grails.apache.org/docs/latest/guide/theWebLayer.html#gsp[Tag Library] to render the address:

[source, groovy]
.grails-app/taglib/example/grails/AddressTagLib.groovy
----
include::../../snippets/grails-app/taglib/example/grails/AddressTagLib.groovy[]
----
