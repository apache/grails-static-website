...
..
.
include::../snippets/build.gradle[indent=0, tag=pullPostgresImage]
include::../snippets/build.gradle[indent=0, tag=createPostgresContainer]
include::../snippets/build.gradle[indent=0, tag=startPostgresContainer]
include::../snippets/build.gradle[indent=0, tag=stopPostgresContainer]
----
