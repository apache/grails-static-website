...
----
include::../snippets/src/main/groovy/example/grails/SearchResult.groovy[]
----

[source, groovy]
.src/main/groovy/example/grails/Album.groovy
----
include::../snippets/src/main/groovy/example/grails/Album.groovy[]
----
...
----
include::../snippets/grails-app/conf/application.yml[tag=mime]
----
...
----
include::../snippets/grails-app/services/example/grails/ItunesSearchService.groovy[tag=searchWithApi]
----
