...
record labels. We will use the grails built-in https://grails.apache.org/docs/latest/guide/REST.html#domainResources[REST API for domain classes].
...
----
include::../snippets/grails-app/domain/example/grails/RecordLabel.groovy[]
----
...
----
include::../snippets/grails-app/services/example/grails/RecordLabelService.groovy[]
----
...
----
include::../snippets/src/integration-test/groovy/example/grails/RecordLabelControllerSpec.groovy[]
----
