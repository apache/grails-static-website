...
----
include::../snippets/src/main/groovy/example/grails/ItunesClient.groovy[]
----
...
----
...
include::../snippets/grails-app/services/example/grails/ItunesSearchService.groovy[tag=autoWireClient]
include::../snippets/grails-app/services/example/grails/ItunesSearchService.groovy[tag=searchWithDeclarativeClient]
...
----
...
----
...
include::../snippets/grails-app/controllers/example/grails/SearchController.groovy[tag=searchWithDeclarativeClientController]
...
----
