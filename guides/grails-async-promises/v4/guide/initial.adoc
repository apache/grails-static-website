The _initial_ folder contains the sample Grails application developed during the Grails Guide: https://grails.apache.org/guides/grails-mock-http-server/guide/index.html[Consume and test a third-party REST API].
