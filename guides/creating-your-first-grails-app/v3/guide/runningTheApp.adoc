...
If you have a local installation of Grails, you can run the app using the https://grails.apache.org/docs/latest/ref/Command%20Line/run-app.html[run-app] command from within your project:
...
Thanks to the https://grails.apache.org/docs/latest/guide/introduction.html#whatsNewGrailsWrapper[Grails Wrapper], as of Grails version 3.2.3 or later, you can run any Grails command without having
Grails installed. If you download it from the https://grails.apache.org/start/[Grails Application Forge], the Grails Wrapper is included too.
...
You can also use Grails' https://grails.apache.org/docs/latest/guide/commandLine.html#interactiveMode[Interactive Mode] to run the Grails runtime, from which you can issue any Grails command without waiting for the runtime to spin up for each task.
