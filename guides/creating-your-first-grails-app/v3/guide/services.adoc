...
.grails-app/services/org/grails/guides/ValueEstimateService.groovy
----
include::../snippets/grails-app/services/org/grails/guides/ValueEstimateService.groovy[]
----
...
----
include::../snippets/grails-app/controllers/org/grails/guides/scaffolding/VehicleController.groovy[indent=0,lines="6..11"]
----
...
.grails-app/controllers/org/grails/guides/VehicleController.groovy
----
include::../snippets/grails-app/controllers/org/grails/guides/VehicleController.groovy[indent=0,lines="18..20"]
----
...
----
include::../snippets/grails-app/views/vehicle/show.gsp[indent=0,lines="17..20"]
----
<1> `<g:formatNumber>` is another GSP tag which provides many useful options for rendering numbers, including currency and decimal precision. See the https://grails.apache.org/docs/latest/ref/Tags/formatNumber.html[Grails documentation] for more.
