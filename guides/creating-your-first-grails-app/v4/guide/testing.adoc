...
You can run your Grails tests using the https://grails.apache.org/docs/latest/ref/Command%20Line/test-app.html[`test-app`] command:
...
----
include::../snippets/src/test/groovy/org/grails/guides/ValueEstimateServiceSpec.groovy[]
----
