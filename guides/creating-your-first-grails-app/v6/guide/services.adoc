...
----
include::../snippets/grails-app/controllers/org/grails/guides/scaffolding/VehicleController.groovy[indent=0,lines="14..16"]
----
...
.grails-app/controllers/org/grails/guides/VehicleController.groovy
----
include::../snippets/grails-app/controllers/org/grails/guides/VehicleController.groovy[indent=0,lines="22..24"]
----
