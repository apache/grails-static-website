...
----
include::../snippets/grails-app/conf/spring/resources.groovy[indent=0,tag=authenticationDetailsSource]
----

[source,groovy]
./src/main/groovy/demo/TwoFactorAuthenticationDetailsSource.groovy
----
include::../snippets/src/main/groovy/demo/TwoFactorAuthenticationDetailsSource.groovy[indent=0]
----
...
----
include::../snippets/src/main/groovy/demo/TwoFactorAuthenticationDetails.groovy[indent=0]
----
