...
----
include::../snippets/src/main/groovy/demo/CoordinateValidator.groovy[indent=0]
----

[source,groovy]
./grails-app/services/demo/CoordinateValidatorService.groovy
----
include::../snippets/grails-app/services/demo/CoordinateValidatorService.groovy[indent=0]
----
...
----
include::../snippets/grails-app/conf/spring/resources.groovy[indent=0,tag=coordinateValidatorBeanDefinition]
----
...
----
include::../snippets/src/main/groovy/demo/TwoFactorAuthenticationProvider.groovy[indent=0]
----
...
./grails-app/conf/spring/resources.groovy
----
include::../snippets/grails-app/conf/spring/resources.groovy[indent=0,tag=twoFactorAuthenticationProviderBeanDefinition]
----
...
----
include::../snippets/grails-app/conf/application.groovy[indent=0,tag=providerNames]
----
