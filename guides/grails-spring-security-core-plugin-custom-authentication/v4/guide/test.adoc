...
----
include::../snippets/src/integration-test/groovy/demo/BankControllerSpec.groovy[indent=0]
----

[source,groovy]
./src/integration-test/groovy/demo/LoginPage.groovy
----
include::../snippets/src/integration-test/groovy/demo/LoginPage.groovy[indent=0]
----
