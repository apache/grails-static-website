...
We are going to use a https://grails.apache.org/docs/latest/guide/single.html#taglibs[Tag Library]
...
____
https://grails.apache.org/docs/latest/ref/Servlet%20API/request.html[forwardURI] - Useful for obtaining the current request URI since the request object’s requestURI property returns the original URI, not the matched one.
____
