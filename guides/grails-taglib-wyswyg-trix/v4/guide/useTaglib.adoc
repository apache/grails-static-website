...
----
include::../snippets/grails-app/views/announcement/create.gsp[indent=0,lines=30..37]
----

[source,groovy]
./grails-app/views/announcement/edit.gsp
----
include::../snippets/grails-app/views/announcement/edit.gsp[indent=0,lines=32..39]
----
