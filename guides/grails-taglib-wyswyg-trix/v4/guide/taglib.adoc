...
----
include::../snippets/grails-app/taglib/demo/TrixTagLib.groovy[indent=0]
----

<1> We use a https://grails.apache.org/docs/latest/guide/theWebLayer.html#namespaces[custom name space]; _trix_
...
----
include::../snippets/src/test/groovy/demo/TrixTagLibSpec.groovy[indent=0]
----
