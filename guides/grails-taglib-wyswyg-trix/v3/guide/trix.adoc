...
----
include::../snippets/grails-app/assets/javascripts/application.js[indent=0, lines=10]
----
...
----
include::../snippets/grails-app/assets/stylesheets/application.css[indent=0, lines=10]
----
