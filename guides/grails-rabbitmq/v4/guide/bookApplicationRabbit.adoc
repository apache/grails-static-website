...
.build.gradle
----
include::../snippets/build.gradle[indent=0, tag=mqDependency]
----
...
----
include::../snippets/grails-app/conf/application.yml[indent=0, tag=mqConfig]
----
...
an https://grails.apache.org/docs/latest/guide/single.html#interceptors[interceptor].
...
----
include::../snippets/grails-app/controllers/demo/BookShowInterceptor.groovy[]
----
