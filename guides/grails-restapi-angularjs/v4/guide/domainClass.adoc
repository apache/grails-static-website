Create a persistent entity to store Todos. Most common way to handle persistence in Grails is the use of https://grails.apache.org/docs/latest/ref/Domain%20Classes/Usage.html[Grails Domain Classes]:
...
----
include::../snippets/grails-app/domain/demo/Todo.groovy[indent=0]
----

With a https://grails.apache.org/docs/latest/guide/testing.html[Unit Test], we test that `name` is a required property.

[source,groovy]
./src/test/groovy/demo/TodoSpec.groovy
----
include::../snippets/src/test/groovy/demo/TodoSpec.groovy[indent=0]
----
...
./grails-app/domain/demo/Todo.groovy
----
include::../snippets/grails-app/domain/demo/Todo.groovy[indent=0,lines=3..6]
----

This annotation exposes the `Todo` domain class as a https://grails.apache.org/docs/latest/guide/webServices.html#domainResources[REST resource]
