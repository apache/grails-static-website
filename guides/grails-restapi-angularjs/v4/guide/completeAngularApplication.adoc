...
----
include::../snippets/../complete-angularjs/index.html[indent=0,lines=16]
----

[source,javascript]
./complete-angularjs/scripts/directives/ngEnter.js
----
include::../snippets/../complete-angularjs/scripts/directives/ngEnter.js[indent=0]
----
...
----
include::../snippets/../complete-angularjs/templates/todos.html[indent=0]
----

[source,javascript]
./complete-angularjs/scripts/controllers/main.js
----
include::../snippets/../complete-angularjs/scripts/controllers/main.js[indent=0]
----
...
----
include::../snippets/../complete-angularjs/scripts/services/data.js[indent=0]
----
