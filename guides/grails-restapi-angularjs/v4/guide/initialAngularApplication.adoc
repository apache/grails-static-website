...
----
include::../snippets/../initial-angularjs/index.html[indent=0]
----
...
----
include::../snippets/../initial-angularjs/scripts/app.js[indent=0]
----
...
----
include::../snippets/../initial-angularjs/scripts/controllers/main.js[indent=0]
----
...
----
include::../snippets/../initial-angularjs/scripts/directives/todos.js[indent=0]
----

[source,javascript]
./initial-angularjs/templates/todos.html
----
include::../snippets/../initial-angularjs/templates/todos.html[indent=0]
----
...
----
include::../snippets/../initial-angularjs/scripts/services/data.js[indent=0]
----

[source,javascript]
./initial-angularjs/mock/todos.json
----
include::../snippets/../initial-angularjs/mock/todos.json[indent=0]
----
